<!-- SCAFFOLD - NOT THE FINAL TEXT ------------------------------------
     scoped fragment `hard_constraints_dc` for the Design Engineer, produced by
...
- The $parameter_count named parameters are the ONLY design levers and there
  ...
  regenerating.  Reject invented parameters — they do not exist.<<MESH_ON>>
...
### Domain hard rules
- The $parameter_count named parameters are the ONLY design levers.<<MESH_ON>>
- The ONLY mesh metrics are watertightness, volume and degenerate-face
  count.<</MESH_ON>>
