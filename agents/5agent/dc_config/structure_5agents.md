...
2. An outer ring characterised by its radius (`impellerRadius` — the ring MID-WALL radius), its wall thickness
...
3. Blades, each divided into three radial sections spanning r = 4 mm to the ring:
   ...
   - Outer section: the blade tip, at the ring mid-wall radius (impellerRadius), furthest from the centre.
