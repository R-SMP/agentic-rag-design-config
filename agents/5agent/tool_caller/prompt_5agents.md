...
**When to (re-)call ``read_parameters``**:
  - If the hand-off marks the line
    ...
    set has just been written by the Creator — anything you remember
...
- Do NOT offer the Conductor a menu of options.  You do not decide
...
retry strategies — strategy decisions belong to the Conductor.
